    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception{
        http.cors().and().csrf().disable().authorizeHttpRequests(configurer->
                configurer
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/employee/{id}").authenticated()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/report/all/{empId}").authenticated()
                        ...
                        .requestMatchers(HttpMethod.PUT, "/api/mentor/feedback").authenticated()
                        )
//                .authorizeRequests()
